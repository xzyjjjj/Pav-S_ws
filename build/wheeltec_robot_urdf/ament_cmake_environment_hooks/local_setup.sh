...
: ${AMENT_CURRENT_PREFIX:="/Pav-S_ws/install/wheeltec_robot_urdf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/wheeltec_robot_urdf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/wheeltec_robot_urdf/environment/path.sh"
