...
#include "wheeltec_robot_msg/msg/detail/data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wheeltec_robot_msg::msg::Data;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const wheeltec_robot_msg::msg::Data *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wheeltec_robot_msg::msg::Data *>(
    untyped_ros_message);
...
{
  return &wheeltec_robot_msg::msg::typesupport_fastrtps_cpp::_Data__handle;
}
