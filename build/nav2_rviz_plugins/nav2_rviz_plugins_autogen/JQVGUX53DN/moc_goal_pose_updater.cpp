...
#include <memory>
#include "../../../../src/navigation2-humble/nav2_rviz_plugins/include/nav2_rviz_plugins/goal_pose_updater.hpp"
...
void nav2_rviz_plugins::GoalPoseUpdater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GoalPoseUpdater *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (GoalPoseUpdater::*)(double , double , double , QString );
...
QT_INIT_METAOBJECT const QMetaObject nav2_rviz_plugins::GoalPoseUpdater::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_nav2_rviz_plugins__GoalPoseUpdater.data,
    qt_meta_data_nav2_rviz_plugins__GoalPoseUpdater,
    qt_static_metacall,
    nullptr,
    nullptr
} };
