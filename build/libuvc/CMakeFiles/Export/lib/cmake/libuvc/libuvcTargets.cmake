...
foreach(_expectedTarget LibUVC::UVCShared LibUVC::UVCStatic)
...
set_target_properties(LibUVC::UVCStatic PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:LibUSB::LibUSB>;\$<LINK_ONLY:Threads::Threads>;\$<LINK_ONLY:JPEG::JPEG>"
)
...
file(GLOB CONFIG_FILES "${_DIR}/libuvcTargets-*.cmake")
