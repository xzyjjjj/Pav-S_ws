...
#include "astra_camera_msgs/msg/detail/metadata__type_support.h"
...
static const _Metadata_type_support_symbol_names_t _Metadata_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, astra_camera_msgs, msg, Metadata)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, msg, Metadata)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, astra_camera_msgs, msg, Metadata)() {
  return &::astra_camera_msgs::msg::rosidl_typesupport_c::Metadata_message_type_support_handle;
}
