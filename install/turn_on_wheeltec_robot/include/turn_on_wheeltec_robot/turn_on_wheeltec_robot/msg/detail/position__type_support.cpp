...
{
  new (message_memory) turn_on_wheeltec_robot::msg::Position(_init);
}

void Position_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turn_on_wheeltec_robot::msg::Position *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Position_message_member_array[3] = {
  {
    ...
    offsetof(turn_on_wheeltec_robot::msg::Position, angle_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turn_on_wheeltec_robot::msg::Position, angle_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turn_on_wheeltec_robot::msg::Position, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Position_message_members = {
  "turn_on_wheeltec_robot::msg",  // message namespace
  "Position",  // message name
  3,  // number of fields
  sizeof(turn_on_wheeltec_robot::msg::Position),
...
get_message_type_support_handle<turn_on_wheeltec_robot::msg::Position>()
{
  return &::turn_on_wheeltec_robot::msg::rosidl_typesupport_introspection_cpp::Position_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turn_on_wheeltec_robot, msg, Position)() {
  return &::turn_on_wheeltec_robot::msg::rosidl_typesupport_introspection_cpp::Position_message_type_support_handle;
}
